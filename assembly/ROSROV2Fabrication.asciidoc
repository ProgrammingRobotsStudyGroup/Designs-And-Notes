...
. If you are using Linux, don’t forget the udev rules.

. Pololu has marvelous documentation. Follow Getting Started in Pololu’s documentation in order to install and test your board. Try some of the examples from Files->Examples->AStar32U4. BuzzerBasics will validate that you can connect to the A-Star. Motors runs a simple motor test.
