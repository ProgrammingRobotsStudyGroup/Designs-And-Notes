...
On the ROS side you need to create a launch file to start the Python code that will communicate with the Arduino sketch.
...
This should be `True` in order to enable the motor controls. (The _base controller_ is a piece of the Arduino sketch.)
